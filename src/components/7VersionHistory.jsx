...
export const VERSION_HISTORY = [
  ...
  },
  {
    ...
    date: '2025-11-27',
    changes: [
      '롤백(Revert): 성적표(Tab 5) 디자인을 v2.08 시점(A4 210x297mm, 기본 패딩/폰트/로고)으로 원복'
    ]
  },
  {
    version: '2.17',
    date: '2025-11-27',
    changes: [
      '디자인 개선: 성적표(Tab 5) 1페이지 Footer 위치를 다른 페이지와 동일하게 맞춤 (Gap/Padding 복구 및 그래프 높이 미세 조정)'
    ]
  },
  {
    version: '2.16',
    date: '2025-11-27',
    changes: [
      '기능 버그 오류 수정: 성적표(Tab 5) 1페이지 하단 잘림 현상 재수정 (Gap 및 Padding 축소)'
    ]
  },
  {
    version: '2.15',
    date: '2025-11-27',
    changes: [
      '기능 버그 오류 수정: 성적표(Tab 5) 1페이지 하단에 쪽 페이지 번호와 학원명 텍스트가 표시되지 않는 문제 해결'
    ]
  },
  {
    version: '2.14',
    date: '2025-11-27',
    changes: [
      '디자인 개선: 성적표(Tab 5) 페이지 크기를 확장(878.4x1198.4px)하여 콘텐츠 영역(780x1100px)을 최적화하고, 내부 그래프 및 여백 비율을 재조정'
    ]
  },
  {
    version: '2.13',
    date: '2025-11-27',
    changes: [
      '디자인 개선: 성적표(Tab 5) 페이지 좌우 여백을 축소하여 내부 콘텐츠 영역 가로 폭을 780px로 확장 (세로 콘텐츠 영역은 978px 유지)'
    ]
  },
  {
    version: '2.12',
    date: '2025-11-27',
    changes: [
      '디자인 개선: 성적표(Tab 5) 페이지 하단 짤림 현상 해결을 위해 내부 그래프 및 여백(Gap/Padding) 비율 최적화 (Page 1 & 2)'
    ]
  },
  {
    version: '2.11',
    date: '2025-11-27',
    changes: [
      '디자인 개선: 성적표(Tab 5) 모든 페이지 크기(794.2x1077.2px) 및 여백(48px), 테두리(1.6px) 고정 (컨텐츠 영역 695x978px 확보)'
    ]
  },
  {
    version: '2.10',
    date: '2025-11-27',
    changes: [
      '디자인 개선: 성적표(Tab 5) 페이지 비율을 A4(210x297mm) 정규격 1:1.41로 고정 및 내부 컨텐츠(그래프 등) 크기 최적화 (Overflow 방지)'
    ]
  },
  {
    version: '2.09',
    date: '2025-11-27',
    changes: [
      '디자인 개선: 성적표(Tab 5) 1페이지 우측 상단 학원 로고 크기 확대',
      '디자인 개선: 성적표(Tab 5) 우측 하단 학원명(MICKEY ENGLISH ACADEMY 미키영어) 폰트를 "Hy헤드라인M"으로 변경'
    ]
  },
  {
    version: '2.08',
    date: '2025-11-27',
    changes: [
      'UI 개선: 화면 상단 헤더 타이틀의 버전 정보가 7번 수정사항 탭의 최신 배포 버전과 자동으로 동기화되도록 로직 개선'
    ]
  },
  {
    version: '2.07',
...
export const LATEST_VERSION = VERSION_HISTORY[0].version;
      ...
      <div className="bg-white p-6 rounded-lg shadow border border-gray-200 h-full overflow-auto">
        <div className="flex items-center justify-between mb-8 border-b pb-4">
          ...
          <div className="text-sm text-gray-500 flex items-center gap-1">
            <Clock size={14}/> 현재 배포: ver {LATEST_VERSION} (최근 업데이트: {VERSION_HISTORY[0].date})
          </div>
        </div>
